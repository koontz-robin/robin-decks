...
> **Rule:** Every new deck or dashboard Robin creates MUST be added here before it's considered done.
> Use the URL format: `https://koontz-robin.github.io/robin-decks/<filename>.html`
> Do NOT use htmlpreview.github.io or raw.githack.com — flagged as malicious by enterprise email security.

---

## 📊 Live Dashboards (auto-refreshed / recurring)

| Name | File | URL | Refresh |
|---|---|---|---|
...
| Expiring Competitor Contracts | expiring-competitor-contracts-dashboard.html | https://koontz-robin.github.io/robin-decks/expiring-competitor-contracts-dashboard.html | Monthly Salesforce report refresh; 6/8-month pursuit windows plus Oct-Dec expirations; excludes accounts with open opportunities and Ardit/Ryan-owned accounts |
...
| Forward Edge - ConnectWise Replacement Evaluation with Rev.io | forward-edge-psa-evaluation-readout.html | https://koontz-robin.github.io/robin-decks/forward-edge-psa-evaluation-readout.html | Buyer-facing Execute readout for Forward Edge ConnectWise replacement: software sprawl, reporting/finance pain, multi-brand Bill Profiles, MSP/VAR workflows, requirements, ROI assumptions, and action plan |
| New York Security Solutions Evaluation Readout | new-york-security-solutions-evaluation-readout.html | https://koontz-robin.github.io/robin-decks/new-york-security-solutions-evaluation-readout.html | Buyer-facing Execute readout for NYSS security integration operations: cloud security, access control, video surveillance, migrations, requirements, ROI assumptions, and action plan |
| Main Line Sound & Video Evaluation Readout | main-line-sound-video-evaluation-readout.html | https://koontz-robin.github.io/robin-decks/main-line-sound-video-evaluation-readout.html | Buyer-facing Execute readout for Main Line Sound & Video: DTools replacement, QuickBooks/inventory fragmentation, Portal IO quoting path, recurring security billing, mobile service workflow, requirements, ROI assumptions, and action plan |
...
| Net Tech: New Rev.io vs. ConnectWise PSA Evaluation | net-tech-new-revio-vs-connectwise-evaluation.html | https://koontz-robin.github.io/robin-decks/net-tech-new-revio-vs-connectwise-evaluation.html | Buyer-facing comparison of shared PSA capabilities, meaningful platform differences, Net Tech-specific tradeoffs, proof requirements, and decision framework. |
...
| Primus Sales — September Update (7-slide deck) | september-update-deck.html | https://koontz-robin.github.io/robin-decks/september-update-deck.html | August final results plus September pacing through Sep 18, 2026, including interactive 2026 ICP created-vs-won trends and complete monthly company rosters |
...
| Q2 Board — Slide 1: Efficiency | q2-board-slide-1-efficiency.html | https://koontz-robin.github.io/robin-decks/q2-board-slide-1-efficiency.html | |
| Q2 Board — Slide 2: Investment | q2-board-slide-2-investment.html | https://koontz-robin.github.io/robin-decks/q2-board-slide-2-investment.html | |
| Q2 Board — Slide 3: Community | q2-board-slide-3-community.html | https://koontz-robin.github.io/robin-decks/q2-board-slide-3-community.html | |
| Q2 Board — Slide 4: Community ROI | q2-board-slide-4-community-roi.html | https://koontz-robin.github.io/robin-decks/q2-board-slide-4-community-roi.html | |
| Q2 Board — Slide 5: Channel | q2-board-slide-5-channel.html | https://koontz-robin.github.io/robin-decks/q2-board-slide-5-channel.html | |
| SDR Deck | sdr-deck.html | https://koontz-robin.github.io/robin-decks/sdr-deck.html | |
| MSP Problems Deck | msp-problems-deck.html | https://koontz-robin.github.io/robin-decks/msp-problems-deck.html | |
| Battle Cards | battle-cards.html | https://koontz-robin.github.io/robin-decks/battle-cards.html | |
...
| Scipio — Rev.io PSA | scipio-revio-psa.html | https://koontz-robin.github.io/robin-decks/scipio-revio-psa.html | |
...
| MNJ Technologies × New Rev.io Pre-Evaluation Readout | mnj-new-revio-evaluation-readout.html | https://koontz-robin.github.io/robin-decks/mnj-new-revio-evaluation-readout.html | Account-specific Execute collateral for moving from legacy billing to a unified service and revenue platform; includes ServiceNow and Power BI positioning plus a scoped Microsoft Dynamics integration path. |
| Nashville Computer Rev.io PSA Evaluation Readout | nashville-computer-revio-psa-evaluation-readout.html | https://koontz-robin.github.io/robin-decks/nashville-computer-revio-psa-evaluation-readout.html | Buyer-facing Execute readout for replacing Autotask/Kaseya: Halo comparison, Neo/Hudu/Ninja/QBO ecosystem, project and billing workflows, payments economics, contingency migration, and evaluation plan. |
...
| Name | File | URL | Notes |
|---|---|---|---|
| Forecast — March 2026 | forecast-march-2026.html | https://koontz-robin.github.io/robin-decks/forecast-march-2026.html | Archived |
| Pipeline — Feb 2026 | pipeline-feb-2026.html | https://koontz-robin.github.io/robin-decks/pipeline-feb-2026.html | Archived |
| Closed Loss — Feb vs Mar | closed-loss-feb-vs-mar.html | https://koontz-robin.github.io/robin-decks/closed-loss-feb-vs-mar.html | |
| Lead Direction Trends | lead-direction-trends.html | https://koontz-robin.github.io/robin-decks/lead-direction-trends.html | |
| Pipeline Creation Slide | pipeline-creation-slide.html | https://koontz-robin.github.io/robin-decks/pipeline-creation-slide.html | |
| PSA Analytics | psa-analytics.html | https://koontz-robin.github.io/robin-decks/psa-analytics.html | |
| PSA Cancellations | psa-cancellations.html | https://koontz-robin.github.io/robin-decks/psa-cancellations.html | |
...
When Robin creates a new deck or dashboard:
1. Save the `.html` file to `/home/openclaw/.openclaw/workspace/`
2. Add it to the appropriate section above
3. Push to `robin-decks` repo so it's live on GitHub Pages
