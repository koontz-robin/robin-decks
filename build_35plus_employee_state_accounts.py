...
<body><main class="wrap"><header><div><h1>Accounts with 35+ Employees</h1><p class="lede">All Salesforce accounts with <b>35 or more employees</b> in RI, MA, CT, NJ, NY, FL, DE, GA, AL, MS, DC, SC, NC, TN, MD, VA, WV, KY, PA, OH, IN, NH, VT, MI, and ME. No owner or activity exclusions applied; International, Bad, and Fringe account tiers are excluded.</p></div><div class="stamp">Generated {e(generated)}<br>Source: Salesforce Account object</div></header>
