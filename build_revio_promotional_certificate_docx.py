...
<w:document xmlns:wpc="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas"
  ...
  <w:body>
    <w:tbl>
      ...
      {tr(tc(p("Limited-Time Partner Offer", size=20, color="0057FF", bold=True, caps=True, after=160) + p("August Promotion", size=58, color="071426", bold=True, line=720, after=160) + p("A Rev.io growth package built for clients ready to kick-off the fall season with a variety of Rev.io offerings.", size=25, color="5F6D80", bold=True, line=330), 6900) + tc(f"<w:tbl><w:tblPr><w:tblW w:w=\"5120\" w:type=\"dxa\"/><w:tblBorders><w:top w:val=\"single\" w:sz=\"8\" w:color=\"DBE5F2\"/><w:left w:val=\"single\" w:sz=\"8\" w:color=\"DBE5F2\"/><w:bottom w:val=\"single\" w:sz=\"8\" w:color=\"DBE5F2\"/><w:right w:val=\"single\" w:sz=\"8\" w:color=\"DBE5F2\"/><w:insideH w:val=\"single\" w:sz=\"6\" w:color=\"D9E3EF\"/><w:insideV w:val=\"nil\"/></w:tblBorders></w:tblPr>{offers}</w:tbl>", 7500, shade="F4F8FC"), height=5200)}
      {tr(field("Company Name", 4100) + field("Contact", 3500) + field("Date", 2600) + field("Sales Represenative", 4200), height=1160)}
      {tr(tc(p("Rev.io promotional certificate", size=17, color="78869A", bold=True, caps=True), 7200) + tc(p("Expires August 31, 2026", size=17, color="78869A", bold=True, caps=True, align="right"), 7200), height=760)}
    </w:tbl>
    <w:sectPr>
