...
'''
    ...
    ids=['slide-1','slide-3','slide-4','slide-5','slide-6']; labels=['August Final','September Pipeline','Efficiency','Pipeline Trends','Closed Lost']
