...
'''
    ...
    ids=['slide-1','slide-5','slide-tigerpaw','slide-tigerpaw-wins','slide-6']; labels=['August + September','Pipeline Trends','Tigerpaw Migration','Tigerpaw Wins','Closed Lost']
