...
'''
    ...
    ids=['slide-1','slide-5','slide-6','slide-tigerpaw','slide-billing-interest']; labels=['August + September','Pipeline Trends','Closed Lost','Tigerpaw Migration + Wins','Billing Client Opportunities + Wins']
