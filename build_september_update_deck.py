...
'''
    ...
    ids=['slide-1','slide-5','slide-tigerpaw','slide-billing-interest','slide-billing-wins','slide-6']; labels=['August + September','Pipeline Trends','Tigerpaw Migration + Wins','Billing Client Interest','Billing Client Wins','Closed Lost']
